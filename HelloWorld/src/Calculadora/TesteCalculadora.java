...
public class TesteCalculadora {
	...
	public static void main(String[] args) {
		Calculadora calc = new Calculadora();
		 ...
		 String valor1 = JOptionPane.showInputDialog(null, "Valor 1 : ", "Valor", JOptionPane.PLAIN_MESSAGE);
		 String valor2 = JOptionPane.showInputDialog(null, "Valor 2 : ", "Valor", JOptionPane.PLAIN_MESSAGE);
		
		//Adição
		 //String valor1 = JOptionPane.showInputDialog(null, "Valor 1 : ", "Adição", JOptionPane.PLAIN_MESSAGE);
		 //String valor2 = JOptionPane.showInputDialog(null, "Valor 2 : ", "Adição", JOptionPane.PLAIN_MESSAGE);
		 System.out.println("Adição : (" + valor1 + " + " + valor2  + ") -> " + calc.somar(Float.parseFloat(valor1), Float.parseFloat(valor2)));
